...
namespace bip47
{
    ...
    using payment_code_identifier = ec_compressed;
    ...
    namespace low
    {
        ...
        const payment_code unmask_payment_code(const payment_code& code, const ec_compressed& designated, const ec_secret& pk, const outpoint& outpoint);
